...
def show_bbox(im, x_min, x_max, y_min, y_max, x1, y1, x2, y2, x3, y3, y4):
    pass


if __name__=="__main__":
    im = '../00000.jpg'
    label = json.load(open('../Point_2d.json', 'r'))["inroom2/001/001"]["00000.jpg"]
    show_hand(im, label, './00000.jpg')